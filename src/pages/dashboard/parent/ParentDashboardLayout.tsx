...
import { Shield, Home, Smartphone, Activity, BarChart3, LogOut, Users, Clock, Wifi, MapPin, Star } from "lucide-react";
...
const ParentDashboardLayout = () => {
  ...
  const navItems = [
    ...
    { path: "/dashboard/parent/tasks", icon: Star, label: "Tasks & Rewards" },
    { path: "/dashboard/parent/location", icon: MapPin, label: "Location" },
    ...
    { path: "/dashboard/parent/consents", icon: Shield, label: "Research Consents" },
